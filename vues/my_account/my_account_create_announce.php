...
/*
				...
				require($_app->base_path.'/vues/create_announce/image_part.php')

				require($_app->base_path.'/vues/create_announce/address_part.php')

				require($_app->base_path.'/vues/create_announce/date_part.php')
