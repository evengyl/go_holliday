...
<div class="col-xs-12 col-without-padding col-without-radius">
		<div class="col-xs-6 col-xs-offset-3">
			<a href="/admin/list_user" type="button" class="btn btn-primary btn-lg btn-block">Edit list user</a>
			...
			<a href="/admin/unit_test_where" type="button" class="btn btn-primary btn-lg btn-block">Unit Test WHERE</a>
		</div>
	</div>
</div>
