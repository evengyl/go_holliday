			...
			<div class="radio">
				...
				<label class="checkbox-inline">
					<input required type="radio" name="price_one_night" 
						<?= (isset($_POST['price_one_night']) && $_POST['price_one_night'] == '0-40')? 'checked="true"' : ''; ?> 
						value="0-40" required>0€ - 40€&nbsp;&nbsp;
				</label>
				<label class="checkbox-inline">
					<input required type="radio" name="price_one_night" 
						<?= (isset($_POST['price_one_night']) && $_POST['price_one_night'] == '41-70')? 'checked="true"' : ''; ?> 
						value="41-70" required>41€ - 70€&nbsp;&nbsp;
				</label>
				<label class="checkbox-inline">
					<input required type="radio" name="price_one_night" 
						<?= (isset($_POST['price_one_night']) && $_POST['price_one_night'] == '71-100')? 'checked="true"' : ''; ?> 
						value="71-100" required>71€ - 100€&nbsp;&nbsp;
				</label>				
				<label class="checkbox-inline">
					<input required type="radio" name="price_one_night" 
						<?= (isset($_POST['price_one_night']) && $_POST['price_one_night'] == '101-150')? 'checked="true"' : ''; ?> 
						value="101-150" required>101€ - 150€&nbsp;&nbsp;
				</label>
				<label class="checkbox-inline">
					<input required type="radio" name="price_one_night" 
						<?= (isset($_POST['price_one_night']) && $_POST['price_one_night'] == '151-200')? 'checked="true"' : ''; ?> 
			...
			<div class="radio">
				...
				<label class="checkbox-inline">
					<input required type="radio" name="price_week_end" 
						<?= (isset($_POST['price_week_end']) && $_POST['price_week_end'] == '101-200')? 'checked="true"' : ''; ?> 
						value="0-100" required>0€ - 100€&nbsp;&nbsp;
				</label>
				<label class="checkbox-inline">
					<input required type="radio" name="price_week_end" 
						<?= (isset($_POST['price_week_end']) && $_POST['price_week_end'] == '101-150')? 'checked="true"' : ''; ?> 
						value="101-150" required>101€ - 150€&nbsp;&nbsp;
				</label>
				<label class="checkbox-inline">
					<input required type="radio" name="price_week_end" 
						<?= (isset($_POST['price_week_end']) && $_POST['price_week_end'] == '151-200')? 'checked="true"' : ''; ?> 
						value="151-200" required>151€ - 200€&nbsp;&nbsp;
				</label>
				<label class="checkbox-inline">
					<input required type="radio" name="price_week_end" 
						<?= (isset($_POST['price_week_end']) && $_POST['price_week_end'] == '201-250')? 'checked="true"' : ''; ?> 
						value="201-250" required>201€ - 250€&nbsp;&nbsp;
				</label>
				<label class="checkbox-inline">
					<input required type="radio" name="price_week_end" 
						<?= (isset($_POST['price_week_end']) && $_POST['price_week_end'] == '251-350')? 'checked="true"' : ''; ?> 
			...
			<div class="radio" style="">
				...
				<label class="checkbox-inline">
					<input required type="radio" name="price_one_week" 
						<?= (isset($_POST['price_one_week']) && $_POST['price_one_week'] == '0-100')? 'checked="true"' : ''; ?> 
						value="0-100" required>0€ - 100€&nbsp;&nbsp;
				</label>
				<label class="checkbox-inline">
					<input required type="radio" name="price_one_week" 
						<?= (isset($_POST['price_one_week']) && $_POST['price_one_week'] == '101-200')? 'checked="true"' : ''; ?> 
						value="101-200" required>101€ - 200€&nbsp;&nbsp;
				</label>
				<label class="checkbox-inline">
					<input required type="radio" name="price_one_week" 
						<?= (isset($_POST['price_one_week']) && $_POST['price_one_week'] == '201-300')? 'checked="true"' : ''; ?> 
						value="201-300" required>201€ - 300€&nbsp;&nbsp;
				</label>
				<label class="checkbox-inline">
					<input required type="radio" name="price_one_week" 
						<?= (isset($_POST['price_one_week']) && $_POST['price_one_week'] == '301-400')? 'checked="true"' : ''; ?> 
						value="301-400" required>301€ - 400€&nbsp;&nbsp;
				</label>
				<label class="checkbox-inline">
					<input required type="radio" name="price_one_week" 
						<?= (isset($_POST['price_one_week']) && $_POST['price_one_week'] == '401-500')? 'checked="true"' : ''; ?> 
						value="401-500" required>401€ - 500€&nbsp;&nbsp;
				</label>
				<label class="checkbox-inline">
					<input required type="radio" name="price_one_week" 
						<?= (isset($_POST['price_one_week']) && $_POST['price_one_week'] == '501-600')? 'checked="true"' : ''; ?> 
						value="501-1000" required>501€ - 1000€&nbsp;&nbsp;
				</label>
				<label class="checkbox-inline">
					<input required type="radio" name="price_one_week" 
						<?= (isset($_POST['price_one_week']) && $_POST['price_one_week'] == '601-800')? 'checked="true"' : ''; ?> 
        ...
        <div class="form-group">
            <div class="input-group">
				...
				<input type="text" name="caution" 
					value="<?= (isset($_POST['caution']))? $_POST['caution'] : ''; ?>" 
